        ...
        <header>
          <div className="text-center">
            ...
            >
              ...
              <span
                aria-hidden="true"
                className="absolute right-[8%] top-[0.25em] block h-[3px] w-[20px] rotate-[-24deg] rounded-full min-[390px]:w-[22px]"
                style={{ backgroundColor: "currentColor" }}
              />
              <span
                aria-hidden="true"
                className="absolute left-[24%] top-[0.25em] block h-[3px] w-[20px] rotate-[-24deg] rounded-full min-[390px]:w-[22px]"
                style={{ backgroundColor: "currentColor" }}
              />
              <span
                dir="ltr"
                className="absolute left-1/2 top-[-0.10em] block -translate-x-1/2 whitespace-nowrap text-center font-serif text-[0.19em] font-semibold tracking-[0.02em]"
                style={{
