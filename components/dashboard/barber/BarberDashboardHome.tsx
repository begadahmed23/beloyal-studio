...
import BarberJoinPanel from "./BarberJoinPanel";
  ...
  const actions = [
    {
      ...
      helper: "Scan a client loyalty card",
    ...
    {
      label: "Add a client",
      helper: "Create a new loyalty member",
      href: "/dashboard/members",
      icon: UserPlus,
    },
    {
      label: "View clients",
      helper: "Search visits and rewards",
      href: "/dashboard/members",
      icon: Users,
    },
    {
    ...
    <div className="space-y-7">
      <section
        ...
        style={{
          ...
          background: `linear-gradient(135deg, ${theme.surfaceRaised} 0%, ${theme.surface} 55%, ${theme.pageBackground} 100%)`,
        ...
        <div className="relative grid gap-7 lg:grid-cols-[1fr_auto] lg:items-center">
          <div>
            ...
            <h2 className="mt-4 max-w-2xl text-3xl font-semibold tracking-[-0.04em] sm:text-4xl">
              Keep every chair busy and every client coming back.
            </h2>
            <p
              className="mt-4 max-w-xl text-sm leading-6"
              style={{ color: theme.textMuted }}
            >
              Record client visits, monitor loyalty activity, and
              manage rewards from one focused workspace.
            </p>
          </div>
          ...
          >
            ...
            <p className="mt-3 text-2xl font-semibold">
              {cafe.rewardTarget} visits
            </p>
            <p
              className="mt-1 text-sm"
              style={{ color: theme.textMuted }}
            >
              then {cafe.rewardName || "Free Haircut"}
            </p>
          </div>
        </div>
      </section>
      ...
      <section>
        <div>
          <p className="text-sm font-semibold">Front desk tools</p>
          <p
            className="mt-1 text-xs"
            style={{ color: theme.textMuted }}
          >
            Fast actions for the daily barber workflow.
          </p>
        </div>
